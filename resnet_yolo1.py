...
train_annot_folder = 'F:\\zzx\\YOLO\yolo_resnet\\basic-yolo-keras-master\\datasets\\VOCzzx_0\\JPEGImages\\'
valid_image_folder = 'F:\\zzx\\YOLO\yolo_resnet\\basic-yolo-keras-master\\datasets\\VOCzzx_0\\JPEGImages\\'
valid_annot_folder = 'F:\\zzx\\YOLO\yolo_resnet\\basic-yolo-keras-master\\datasets\\VOCzzx_0\\JPEGImages\\'
...
checkpoint = ModelCheckpoint('weights_zzx_yolo_res_608_1.h5',
                             monitor='loss', 
                             verbose=1, 
                             save_best_only=True, 
                             mode='min', 
...
tb_counter  = len([log for log in os.listdir(os.path.expanduser('F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\logs\\zzx_yolo\\logs_608\\')) if 'coco_zzx_yolo_' in log]) + 1
tensorboard = TensorBoard(log_dir=os.path.expanduser('F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\logs\\zzx_yolo\\logs_608\\') + 'coco_zzx_yolo_' + '_' + str(tb_counter),
                          histogram_freq=0, 
                          write_graph=True, 
                          write_images=True)
...
model.load_weights("weights_zzx_yolo_res_608.h5")
