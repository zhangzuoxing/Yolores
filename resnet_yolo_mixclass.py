...
train_image_folder = 'F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\datasets\\mixed_class\\1\\'
train_annot_folder = 'F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\datasets\\mixed_class\\Annotations2\\'
valid_image_folder = 'F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\datasets\\mixed_class\\val\\'
valid_annot_folder = 'F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\datasets\\mixed_class\\val_ann\\'
...
checkpoint = ModelCheckpoint('weights_res_mixed.h5',
                             monitor='loss', 
                             verbose=1, 
                             save_best_only=True, 
                             mode='min', 
...
tb_counter  = len([log for log in os.listdir(os.path.expanduser('F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\logs\\zzx_yolo\\')) if 'mixed_' in log]) + 1
tensorboard = TensorBoard(log_dir=os.path.expanduser('F:\\zzx\\YOLO\\yolo_resnet\\basic-yolo-keras-master\\logs\\zzx_yolo\\') + 'mixed_' + '_' + str(tb_counter),
                          histogram_freq=0, 
                          write_graph=True, 
                          write_images=False)
...
model.load_weights("weights_zzx_yolo_res_544_mixedclass.h5")
